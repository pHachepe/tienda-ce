        ...
        <div class="flex gap-8 flex-wrap md:flex-nowrap">
            ...
            <div class="bg-white p-6 shadow-md w-1/2">
                ...
                <div class="mb-4">
                    ...
                    <input required id="direccion" name="direccion" type="text" placeholder="Calle, Número, Piso, CP, Ciudad, Provincia" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-600" value="<?= isset(
                        $_SESSION["loggedin"]
                    )
                ...
                <div class="mb-6">
                    ...
                    <input required id="tarjeta" name="tarjeta" type="text" placeholder="1111 2222 3333 4444" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-600" value="<?= isset(
                        $_SESSION["loggedin"]
                    )
