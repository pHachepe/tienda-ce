    ...
    <article class="flex space-x-4 border-b p-4">
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div class="space-x-2 flex items-center">
              <input type="number" name="cantidad" value="${product.cantidad}" min="1" class="mb-1 ml-1 border border-gray-300 px-2 py-1 rounded-lg w-20 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" onchange="updateProductQuantity(${product.id}, this.value)" />
